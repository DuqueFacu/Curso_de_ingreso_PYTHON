...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert(title="sumador", message= "el resultado de la suma es " + resultado_a_texto)
    ...
    def btn_restar_on_click(self):
        ...
        resultado_a_texto=str(resultado)
        alert(title="restador", message= "el resultado de la resta es " + resultado_a_texto)
    ...
    def btn_multiplicar_on_click(self):
        ...
        resultado_a_texto=str(resultado)
        alert(title="multiplicador", message= "el resultado de la multiplicacion es " + resultado_a_texto)
    ...
    def btn_dividir_on_click(self):
        ...
        resultado_a_texto=str(resultado)
        alert(title="divisor", message= "el resultado de la division es " + resultado_a_texto)
